...
学習を重ねていると、ふとネガティブな思考に陥ることがあります。

- **「自分は本当に頑張れているのだろうか」「このままで良いのだろうか」と落ち込む**
- **自信が持てないまま**学習継続日数や累計学習時間が積み上がっていき、**数字だけが増えていく気がして不安になる**
- 同じように学習を重ねている方を見ると「すごいな」「頑張っているな」と思えるのに、**自分自身のことはそう思えず、もやもやする**
  こうした思いが生まれるとなかなか消えてくれず、一度振り払ってもしばらく経つとまた生まれてきてしまいます。<br>
  自分の学習を振り返るきっかけにもなり得るかもしれませんが、ネガティブな思考に囚われて手が止まってしまっては元も子もないことです。<br>
  そこで、学習日数や学習時間のほかに**自分の日々の頑張りを実感できる指標**
  のようなものがあればモチベーションを維持する一助になるのではないかと考えました。<br>
  <br>
...
- 自分の行動によって獲得したえらい！が増えていく様子や、自分を褒めるメッセージを日常的に目にすることで **「行動できてる自分えらい！」「自分もちゃんと頑張れているんだ！』と実感する
  **ことができ、自己肯定感が高まります
  なお、このアプリは自己肯定感を高めてモチベーションの維持、学習の継続をサポートすることを目的としており、その効果を保証するものではございません。<br>
  <br>

## 👥 想定ユーザー

- 何かしらの学習に取り組んでいる / 取り組もうとしている個人
- 学習中に不安を感じている / 感じたことのある個人
  <br>
  <br>
